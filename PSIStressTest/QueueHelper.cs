...
namespace TimeSheetBusiness
{
    public  static class QueueHelper
    {
        ...
        public static bool WaitForQueueJobCompletion(Repository repository, Guid trackingGuid, int messageType, SvcQueueSystem.QueueSystemClient queueSystemClient)
        {
